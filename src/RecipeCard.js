...
function RecipeCard(props){
   ...
   const thisDrink = props.drinks.map(drink => {
    const {
        idDrink,
        strDrinkThumb,
        strDrink,
            ...
            <div className="recipeCard">
                ...
                <div className="recipeCard--details">
                    ...
                    <ul style={{margin:"0", fontSize:"12px"}}>
                        ...
                        {props.save &&  <button className="recipeCard--save" style={{alignSelf:"flex-start", justifyContent:"flex-start"}}><img src="https://cdn3.iconfinder.com/data/icons/carbon-mobile-browser/48/add-favorites-512.png" alt="favIcon"  id={idDrink} onClick={saveRecipe}/></button>}
